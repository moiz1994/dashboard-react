        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            <li className="nav-item dropdown d-none d-lg-block">
              <Link className="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" to="#">+ Create New Project</Link>
            ...
            <li className="nav-item dropdown border-left">
              <Link className="nav-link count-indicator dropdown-toggle" id="messageDropdown" to="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <Link className="dropdown-item preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1">Mark send you Link message</p>
                ...
                <Link className="dropdown-item preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1">Cregh send you Link message</p>
              ...
              <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <Link className="dropdown-item preview-item">
                  ...
                  <div className="preview-item-content">
                    ...
                    <p className="text-muted ellipsis mb-0"> Just Link reminder that you have an event today </p>
                  </div>
                </Link>
                <div className="dropdown-divider"></div>
                <Link className="dropdown-item preview-item">
            ...
            <li className="nav-item dropdown">
              <Link className="nav-link" id="profileDropdown" to="#" data-toggle="dropdown">
